...
- **Bolt B-03 (U-TRANS - Multi-sig Cryptographic Engine):**
  - [Modelo de Dominio](aidlc-docs/mob-construction/B-03/domain_model.md)
  - [Diseño Lógico y API Contract](aidlc-docs/mob-construction/B-03/logical_design.md)
